...
router.route('/create-many').post(authentication, restrictTo("Super Admin"), createManyProduct)
router.route('/create-single').post(authentication, restrictTo("Super Admin"), createSingleProduct)
